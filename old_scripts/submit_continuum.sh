...
LOGFILE="continuum_p16_res1e-12_delta_cells1000_length1_u1_nd.log"

# Mass density representation
#srun ./pbIterativeSolver -cells 1000 -length 1 -u 1 -k continuum -p 16 -res 1e-12 -mass -nin mono &> $LOGFILE

# Number density representation
srun ./pbIterativeSolver -cells 1000 -length 1 -u 1 -k continuum -p 16 -res 1e-12 -nin mono &> $LOGFILE
